...
def build_nav_html(prefix):
    ...
    html.append(f'<a class="nav-link" href="{link(prefix,"contact.html")}">索取報價</a>')
    return ''.join(html)
...
<body class="subpage" data-page="{key}" data-prefix="{prefix}">
  <header class="site-header" id="site-header"><div class="nav-shell">
    ...
    <a class="nav-cta" href="{link(prefix,'contact.html')}">索取報價 <span aria-hidden="true">↗</span></a>
  </div></header>
  <main>
    ...
    <section class="subpage-plans" id="page-plans-section"><div class="section-shell"><p class="eyebrow eyebrow--blue"><span class="eyebrow-dot"></span> PLAN / 方案選擇</p><h2>不變的是，<br><em>每一個需求都要先說清楚。</em></h2><div class="subpage-plan-grid" id="page-plans"></div></div></section>
